        ...
        <div className="px-5 sm:px-8 pb-4 flex gap-2 overflow-x-auto">
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-[13px] font-bold whitespace-nowrap transition-all ${activeFilter === tab.id
                ...
                <tbody>
                  {filteredMedicines.map(medicine => (
                    <tr key={medicine._id} className="border-b border-gray-100 last:border-b-0 hover:bg-[#F9FAFB] transition-colors group">
                      ...
                      <td className="py-4 px-4">
                        <span className={`inline-flex items-center rounded-full px-3 py-1 text-[12px] font-bold border ${medicine.status === 'In Stock'
              ...
              {filteredMedicines.map(medicine => (
                <div key={medicine._id} className="bg-[#F9FAFB] rounded-[20px] p-4 border border-gray-100 hover:border-[#1EBDB8]/25 transition-colors">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-bold border shrink-0 ${medicine.status === 'In Stock'
                        ? 'bg-[#ECFCFB] text-[#1EBDB8] border-[#1EBDB8]/20'
                        : 'bg-rose-50 text-rose-600 border-rose-200'
                      }`}>
                      {medicine.status}
